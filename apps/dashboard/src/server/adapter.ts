...
import type { Prisma, PrismaClient } from "@metrik/db/client";
...
export function PrismaAdapter(
  ...
  return {
    ...
    getUser: (id) =>
      p.user.findUnique({ where: { id } }) as unknown as AdapterUser,
    getUserByEmail: (email) =>
      p.user.findUnique({ where: { email } }) as unknown as AdapterUser,
    ...
    createSession: (data) => p.session.create({ data: { ...data, id: nid() } }),
    updateSession: (data) =>
